...
def return_last_element(list_of_integers: list):
    if not list_of_integers:
        return None
    else:
        return list_of_integers[-1]

def return_first_element(list_of_integers: list):
    if not list_of_integers:
        return None
    else:
        return list_of_integers[0]

def single_liner_return_last_element(list_of_integers: list):
    return list_of_integers[-1] if list_of_integers else None

def single_liner_return_first_element(list_of_integers: list):
